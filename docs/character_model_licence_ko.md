# VRM 및 Live2D 모델 이용 약관

## 개요

이 문서는 Queue 주식회사의 프로젝트에서 제공되는 다음 모델들의 이용 약관을 규정합니다:
...
- Queue VRM 모델 v1: [琳 様](https://x.com/rin_tyn25)
- Queue VRM 모델 v2: [たまごん 様](https://x.com/_TAMA_GON_)
- Queue VRM 모델 v2 (아우터): [たまごん 様](https://x.com/_TAMA_GON_)
