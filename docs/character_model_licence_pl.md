# Warunki użytkowania modeli VRM i Live2D

## Przegląd

Ten dokument określa warunki użytkowania następujących modeli dostępnych w tym projekcie:

### Modele VRM

- Model VRM Queue v1
- Model VRM Queue v2
- Model VRM Queue v2 (Odzież wierzchnia)
...
- Model VRM Queue v1: [Rin](https://x.com/rin_tyn25)
- Model VRM Queue v2: [TAMA GON](https://x.com/_TAMA_GON_)
- Model VRM Queue v2 (z odzieżą wierzchnią): [TAMA GON](https://x.com/_TAMA_GON_)
