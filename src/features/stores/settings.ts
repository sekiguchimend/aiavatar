  ...
  persist(
    (set, get) => ({
      ...
      aivisCloudUseStyleName:
        process.env.NEXT_PUBLIC_AIVIS_CLOUD_USE_STYLE_NAME === 'true' || false,
      aivisCloudSpeed:
      ...
      aivisCloudTempoDynamics:
        parseFloat(
          process.env.NEXT_PUBLIC_AIVIS_CLOUD_TEMPO_DYNAMICS || '1.0'
        ) || 1.0,
      aivisCloudIntonationScale:
        parseFloat(
          process.env.NEXT_PUBLIC_AIVIS_CLOUD_INTONATION_SCALE || '1.0'
        ) || 1.0,
