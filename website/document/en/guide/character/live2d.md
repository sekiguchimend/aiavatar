...
Live2D is a model format that allows realistic movement to be added to 2D illustrations, and in This project, you can use Live2D models to display AI characters.
...
Live2D provides a library called Cubism as a development SDK, and This project uses the official SDK with permission from Live2D.
...
This project supports Live2D Cubism 3 and later models. To use a Live2D model, follow these steps:
...
- The default values correspond to the models provided with This project

### Model Compatibility

This project supports Cubism 3 and later models, but some models may not work properly due to compatibility issues.
...
When using Live2D models commercially with This project, please note the following:
