...
VRM (Virtual Reality Model) is a 3D character model format, and in This project, you can use VRM models to display AI characters.
...
This project supports the following VRM versions:
