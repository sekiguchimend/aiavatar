...
To use This project, you need the following software:
...
You can start using This project by opening [http://localhost:3000](http://localhost:3000) in your browser.
...
- Set up YouTube streaming in [Youtube Settings](/en/guide/youtube-settings)
