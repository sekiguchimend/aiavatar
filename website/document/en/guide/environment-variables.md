...
This page explains all environment variables that can be used with This project. These environment variables can be set in the `.env` file to customize the behavior of the application.
...
```bash
# Character name
NEXT_PUBLIC_CHARACTER_NAME=Queue
...
# Character presets
NEXT_PUBLIC_CHARACTER_PRESET1="You are an AI assistant named Queue."
NEXT_PUBLIC_CHARACTER_PRESET2="You are an AI assistant named Queue."
NEXT_PUBLIC_CHARACTER_PRESET3="You are an AI assistant named Queue."
NEXT_PUBLIC_CHARACTER_PRESET4="You are an AI assistant named Queue."
NEXT_PUBLIC_CHARACTER_PRESET5="You are an AI assistant named Queue."
```
