...
This page summarizes common problems and their solutions when using This project. We will continue to add typical errors and issues along with their causes and solutions, providing detailed explanations based on specific cases to support smooth operation.

## TypeError: \_currentFrameNo when loading Live2D models

::: warning Symptoms
When selecting a custom Live2D model in This project, the following error appears and the model does not render.
...
- Additionally, models exported in Cubism 5 format (.moc3 v4) are not compatible with the libraries included in This project.
...
4. Place the output folder in `public/live2d/model-name/` and reselect `model-name.model3.json` in This project.
...
If your model renders correctly in This project after following these steps, you're all set.
