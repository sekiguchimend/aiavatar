...
This project is an open-source toolkit that allows anyone to easily build web applications for chatting with AI characters. It features AI character interaction and streaming functions, along with various extension capabilities.
