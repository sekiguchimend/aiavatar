...
- The voice model selected in the This project settings is used
...
- If multiple messages are sent, they are processed in order
- The AI model and voice model selected in the This project settings are used
- How to set the system prompt:
  - To use the This project system prompt, set `useCurrentSystemPrompt: true`
...
- The sent message is processed the same as if it were input from the This project input form
- If multiple messages are sent, they are processed in order
- The AI model and voice model selected in the This project settings are used
- The system prompt and conversation history from This project are used
