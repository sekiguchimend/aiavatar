...
This page explains the basic settings of This project. For configuration using environment variables, please see [Environment Variables](/en/guide/environment-variables).
...
This project supports multiple languages, and you can choose from the following:
