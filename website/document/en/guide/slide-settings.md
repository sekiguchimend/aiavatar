...
This project includes demo slides by default. To check the functionality of slide mode, we recommend trying the demo slides first.
...
1. **scripts.json** (required): Script file. Includes the content of each slide and additional information.
   ...
   [
     {
       "page": 0,
       "line": "I will now begin explaining the slide mode of This project.",
       "notes": ""
     },
     {
       "page": 1,
       "line": "Before starting to develop slide mode, you need to be able to converse with This project, so please prepare for that.",
...
- Easily convert existing slides created with PowerPoint, etc. for use with This project
