...
Multimodal AI models are AI models that can understand and process multiple forms of information (modalities), not just text but also images and audio. In This project, you can utilize these multimodal features to create a richer interaction experience.
...
This project supports the following multimodal-compatible AI services and models:
