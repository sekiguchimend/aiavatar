...
External Linkage Mode is a feature that allows This project to connect with external applications via WebSocket. Using this mode, you can send text messages from external applications and make the This project character speak.
...
- This project is only responsible for receiving text and generating voice and motion

## Setup Procedure

1. Set "External Linkage Mode" to ON in the This project settings screen
