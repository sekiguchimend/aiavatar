...
This project is provided under a custom license from version **v2.0.0** onwards.
...
If you are unsure about which license to choose or have any questions, please feel free to contact **queue@queue-tech.jp**.

## Detailed Information

For detailed information about the license and frequently asked questions, please refer to the following links:

- [License Details](./license_en.md)
- [License FAQ](./license-faq_en.md)
