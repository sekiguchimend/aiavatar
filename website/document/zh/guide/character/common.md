...
# 字元預設
NEXT_PUBLIC_CHARACTER_PRESET1="您是一位名叫 Queue 的 AI 助理。"
NEXT_PUBLIC_CHARACTER_PRESET2="您是一位名叫 Queue 的 AI 助理。"
NEXT_PUBLIC_CHARACTER_PRESET3="您是一位名叫 Queue 的 AI 助理。"
NEXT_PUBLIC_CHARACTER_PRESET4="您是一位名叫 Queue 的 AI 助理。"
NEXT_PUBLIC_CHARACTER_PRESET5="您是一位名叫 Queue 的 AI 助理。"
```
...
在本项目中，您可以使用情感标签来控制角色的表情和动作。支持以下情感标签：
