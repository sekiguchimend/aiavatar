...
Live2D是一种可以为2D插图添加真实动作的模型格式，在本项目中，您可以使用Live2D模型来显示AI角色。
...
Live2D提供了一个名为Cubism的库作为开发SDK，本项目在获得Live2D公司许可的情况下使用官方SDK。
...
本项目支持Live2D Cubism 3及更高版本的模型。要使用Live2D模型，请按照以下步骤操作：
...
本项目支持Cubism 3及更高版本的模型，但由于兼容性问题，某些模型可能无法正常工作。
