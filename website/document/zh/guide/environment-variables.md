...
本页面说明了本项目可以使用的所有环境变量。这些环境变量可以在`.env`文件中设置，以自定义应用程序的行为。
...
# 角色预设
NEXT_PUBLIC_CHARACTER_PRESET1="你是一个名叫Queue的AI助手。"
NEXT_PUBLIC_CHARACTER_PRESET2="你是一个名叫Queue的AI助手。"
NEXT_PUBLIC_CHARACTER_PRESET3="你是一个名叫Queue的AI助手。"
NEXT_PUBLIC_CHARACTER_PRESET4="你是一个名叫Queue的AI助手。"
NEXT_PUBLIC_CHARACTER_PRESET5="你是一个名叫Queue的AI助手。"
```
