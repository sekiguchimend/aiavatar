...
- 音声モデルは本プロジェクトの設定で選択したものが使用されます
...
- 複数のメッセージを送信した場合は、順番に処理されます
- AIモデルおよび音声モデルは本プロジェクトの設定で選択したものが使用されます
- システムプロンプトの設定方法：
  - 本プロジェクトのシステムプロンプトを使用する場合は `useCurrentSystemPrompt: true` を設定
...
- 送信したメッセージは本プロジェクトの入力フォームから入力された場合と同じ処理がされます
- 複数のメッセージを送信した場合は、順番に処理されます
- AIモデルおよび音声モデルは本プロジェクトの設定で選択したものが使用されます
- システムプロンプトや会話履歴は本プロジェクトの値が使用されます
