...
このページでは、本プロジェクトで使用できるすべての環境変数を説明します。これらの環境変数は、`.env`ファイルに設定することで、アプリケーションの動作をカスタマイズできます。
...
# キャラクタープリセット
NEXT_PUBLIC_CHARACTER_PRESET1="あなたはQueueという名前のAIアシスタントです。"
NEXT_PUBLIC_CHARACTER_PRESET2="あなたはQueueという名前のAIアシスタントです。"
NEXT_PUBLIC_CHARACTER_PRESET3="あなたはQueueという名前のAIアシスタントです。"
NEXT_PUBLIC_CHARACTER_PRESET4="あなたはQueueという名前のAIアシスタントです。"
NEXT_PUBLIC_CHARACTER_PRESET5="あなたはQueueという名前のAIアシスタントです。"
```
