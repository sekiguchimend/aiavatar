...
Live2Dは2Dイラストにリアルな動きを付けることができるモデル形式で、本プロジェクトではLive2Dモデルを使用してAIキャラクターを表示することができます。
...
Live2Dは開発用SDKとしてCubismというライブラリが提供されており、本プロジェクトでは、Live2D社の許可を得て、公式SDKを使用しています。
...
本プロジェクトでは、Live2D Cubism 3以降のモデルに対応しています。Live2Dモデルを使用するには、以下の手順に従ってください：
...
- 初期値は本プロジェクトで用意しているモデルに対応したものです

### モデルの互換性について

本プロジェクトではCubism 3以降のモデルに対応していますが、モデルによっては互換性の問題で正常に動作しない場合があります。
...
本プロジェクトでLive2Dモデルを商用利用する場合は、以下の点にご注意ください：
